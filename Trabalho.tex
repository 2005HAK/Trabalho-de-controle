...
\section{Modelamento do sistema}
    ...
    \subsection{Análise do sistema}
        ...
        Com isso é possivel fazer a análise do sistema plotando o seu lugar das raízes no matlab, como mostrado na figura \ref{fig:root locus open loop}.

        \begin{figure}[H]
            \centering
            \includegraphics[width=0.8\textwidth]{img/root_locus_open_loop.jpg}
            \caption{Lugar das raízes do sistema em malha aberta}
            \label{fig:root locus open loop}
        \end{figure}
